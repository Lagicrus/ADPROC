...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            starting_scores = console.nextLine();
            score_parts = starting_scores.split(" ");
            System.out.println(starting_scores);
            for (String score: score_parts){
                if (this.isNumeric(score)){
                    sMarks[score_parts.] = score;
                }
            }
